      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.statusCard}>
          <View style={styles.statusHeader}>
            <Icon
              name={state.isStreaming ? 'play-circle-filled' : 'pause-circle-filled'}
              size={48}
        ...
        <View style={styles.card}>
          ...
          {audioFiles.map((audio, index) => (
            <TouchableOpacity
              ...
              <Icon
                name={selectedAudio === audio.file ? 'radio-button-checked' : 'radio-button-unchecked'}
                size={24}
          ...
          <View style={styles.volumeContainer}>
            ...
            <View style={styles.volumeSliderContainer}>
              <View style={styles.volumeTrack}>
                <View 
                  style={[styles.volumeProgress, {width: `${state.volume * 100}%`}]} 
                />
              </View>
              <TouchableOpacity 
              ...
              <View key={device.id} style={styles.deviceItem}>
                ...
                <View style={styles.deviceInfo}>
                  ...
                  <Text style={styles.devicePlatform}>
                    {device.platform} • {device.average_latency ? 
                ...
                <View
                  style={[
                    styles.deviceStatus,
                    {backgroundColor: device.enabled !== false ? '#4CAF50' : '#F44336'},
                  ]}
                />
              </View>
            ))
          ...
          <View style={styles.card}>
            ...
            <View style={styles.syncInfo}>
              <View style={styles.syncItem}>
                ...
                <Text style={styles.syncValue}>{Math.round(state.latency * 1000)}ms</Text>
              </View>
              <View style={styles.syncItem}>
                <Text style={styles.syncLabel}>Sync Quality:</Text>
                <Text style={[
                  styles.syncValue,
                  {color: state.latency < 0.05 ? '#4CAF50' : state.latency < 0.1 ? '#FF9800' : '#F44336'}
                ]}>
                  {state.latency < 0.05 ? 'Excellent' : state.latency < 0.1 ? 'Good' : 'Poor'}
                </Text>
              </View>
            </View>
          </View>
